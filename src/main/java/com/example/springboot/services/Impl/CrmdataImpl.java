...
public class CrmdataImpl implements CrmdataServices {
    ...
    @Override
    public int InsertCrmdata5(String phone, String source, String url, String con, String firsttime, String ip, String plankey) {
        return crmdataMapper.InsertCrmdata5(phone, source, url, con, firsttime, ip, plankey);
    }
    ...
    public List<Crmdata> SelectYouXiaoSearh(int uid, String phone, int color, int page) {
        if(color == 999 && phone.equals("0")){

            System.out.println("啥都没有");
            System.out.println(crmdataMapper.SelectYouXiao(uid, 10*(page-1)));
            return crmdataMapper.SelectYouXiao(uid, 10*(page-1));
        }else if(color == 999){

            System.out.println("没有color");
            ...
            System.out.println("没有phone");
            return crmdataMapper.SelectYouXiaoSearhAndPhoneIsNull(uid, color, 10*(page-1));
    ...
    @Override
    public List<Crmdata> SelectYouXiaoSearhAndPhoneIsNull(int uid, int color, int page) {
        return crmdataMapper.SelectYouXiaoSearhAndPhoneIsNull(uid,color,page);
    }
    ...
    @Override
    public List<Crmdata> SelectCrmdataBySourceBySourceIsNull(String starttime, String endtime, int page) {
        return crmdataMapper.SelectCrmdataBySourceBySourceIsNull(starttime, endtime, 10*(page-1));
    }

    @Override
    public CrmdataCount SelectCrmdataCountBySourceIsNull(String starttime, String endtime) {
        return crmdataMapper.SelectCrmdataCountBySourceIsNull(starttime, endtime);
    }
    ...
    @Override
    public List<Crmdata> SelectCrmdataBySourceIsSearch(String phone) {
        return crmdataMapper.SelectCrmdataBySourceIsSearch(phone);
    }

    @Override
    public int ApiJiMuYuCon_Add(String phone, String source, String url, String con, String firsttime, String ip, String plankey) {
        return crmdataMapper.ApiJiMuYuCon_Add(phone, source, url, con, firsttime, ip, plankey);
    }
