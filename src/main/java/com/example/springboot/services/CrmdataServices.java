...
public interface CrmdataServices {
    ...
    int InsertCrmdata5(@Param("phone")String phone,
                       @Param("source")String source,
                       @Param("url")String url,
                       @Param("con")String con,
                       @Param("firsttime")String firsttime,
    ...
    public  List<Crmdata> SelectYouXiaoSearhAndPhoneIsNull(@Param("uid")int uid,@Param("color")int color,@Param("page")int page );
    ...
    public SourceSize SelectCrmdataBySourceSize(
            ...
            @Param("starttime")String starttime,
            @Param("endtime")String endtime);
    public List<Crmdata> SelectCrmdataBySourceBySourceIsNull(
            @Param("starttime")String starttime,
            @Param("endtime")String endtime,
            @Param("page")int page);
    public CrmdataCount SelectCrmdataCountBySourceIsNull(
            @Param("starttime")String starttime,
            @Param("endtime")String endtime);
    ...
    public List<Crmdata> SelectCrmdataBySourceIsSearch(
            @Param("phone") String phone
    );

    int ApiJiMuYuCon_Add(@Param("phone")String phone,
                         @Param("source")String source,
                         @Param("url")String url,
                         @Param("con")String con,
                         @Param("firsttime")String firsttime,
